...
namespace LowCodeInternal_BusinessApps_Automation.TestData
{
    class Data
    {
        ...
        public string? NationalAcct { get; set; }
        ...
        public string? DashboardYearDropdown { get; set; }
